  ...
  {
    {
      ...
      .val_default = GAVL_VALUE_INIT_STRING("delay"),
    ...
    },
    {
      ...
      .type = BG_PARAMETER_STRINGLIST,
      .flags = BG_PARAMETER_SYNC,
      .val_default = GAVL_VALUE_INIT_STRING("mirror"),
    ...
    },
    {
      ...
      .val_max =     GAVL_VALUE_INIT_INT(PLANES-1),
...
static void set_parameter(void * data, const char * name,
  ...
  if(!strcmp(name, "mode"))
    {
    if(!strcmp(val->v.str, "delay"))
      priv->mode = 0;
    else if(!strcmp(val->v.str, "scratch"))
      priv->mode = 1;
    else if(!strcmp(val->v.str, "nervous"))
      priv->mode = 2;
    else
      priv->mode = 0;
    }
  ...
  if(!strcmp(name, "mirror"))
    {
    if(!strcmp(val->v.str, "normal"))
      priv->mirror = 0;
    else if(!strcmp(val->v.str, "mirror"))
      priv->mirror = 1;
