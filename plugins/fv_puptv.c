  ...
  {
    {
      ...
      .val_default = GAVL_VALUE_INIT_STRING("horizontal"),
...
static void set_parameter(void * data, const char * name,
  ...
  if(!strcmp(name, "mode"))
    {
    if(!strcmp(val->v.str, "horizontal"))
      priv->mode = 1;
    else if(!strcmp(val->v.str, "vertical"))
      priv->mode = 0;
    else if(!strcmp(val->v.str, "diagonal"))
      priv->mode = 2;
    else if(!strcmp(val->v.str, "dissolution"))
      priv->mode = 3;
    else if(!strcmp(val->v.str, "random"))
      priv->mode = 4;
    else if(!strcmp(val->v.str, "raster"))
      priv->mode = 5;
    priv->phase = 0;
    }
