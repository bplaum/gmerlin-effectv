  ...
  {
    {
      ...
      .val_default = GAVL_VALUE_INIT_STRING("maelstrom"),
    ...
    },
    {
      ...
      .flags = BG_PARAMETER_SYNC,
      .val_min =     GAVL_VALUE_INIT_INT(-64),
      .val_max =     GAVL_VALUE_INIT_INT(64),
...
static void set_parameter(void * data, const char * name,
  ...
  if(!strcmp(name, "mode"))
    ...
    if(!strcmp(val->v.str, "maelstrom"))
      priv->mode = 0;
    else if(!strcmp(val->v.str, "radiation"))
      priv->mode = 1;
