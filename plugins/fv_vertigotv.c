  ...
  {
    {
      ...
      .val_max =     GAVL_VALUE_INIT_FLOAT(1.00),
      .val_default = GAVL_VALUE_INIT_FLOAT(0.02),
      .num_digits = 2,
    },
    {
      .name =      "zoomrate",
      ...
      .type = BG_PARAMETER_SLIDER_FLOAT,
      .flags = BG_PARAMETER_SYNC,
      .val_min =     GAVL_VALUE_INIT_FLOAT(1.01),
      .val_max =     GAVL_VALUE_INIT_FLOAT(1.1),
      .val_default = GAVL_VALUE_INIT_FLOAT(1.01),
      .num_digits = 2,
    },
    { /* */ },
  };
